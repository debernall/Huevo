...
t1 = np.genfromtxt("Matriz33Copia.dat")
t2 = np.genfromtxt("Matriz66Copia.dat")
t3 = np.genfromtxt("Matriz100Copia.dat")
...
scatter2 = ax2.scatter3D(x.flatten(), y.flatten(), z.flatten(), c=t1.flatten()*1, cmap='inferno', s=size, vmin=0, vmax=100)		
ax2.view_init(ang1,ang2)								
ax2.set_title("t=33% Tiempo")

ax3 = fig.add_subplot(2,2,3, projection='3d')					
scatter3 = ax3.scatter3D(x.flatten(), y.flatten(), z.flatten(), c=t2.flatten()*1, cmap='inferno', s=size, vmin=0, vmax=100)		
ax3.view_init(ang1,ang2)								
ax3.set_title("t=66% Tiempo")

ax4 = fig.add_subplot(2,2,4, projection='3d')					
scatter4 = ax4.scatter3D(x.flatten(), y.flatten(), z.flatten(), c=t3.flatten()*1, cmap='inferno', s=size, vmin=0, vmax=100)	
...
plt.savefig('TemperaturaCopia.jpg')
