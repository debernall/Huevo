...
tm = np.genfromtxt("TemperaturaMediaCopia.dat", delimiter=";", skip_header=1)						#Importo la matriz de temperaturas almacenado como vector
tm = np.transpose(tm)
...
ax.set(xlabel='Tiempo (Minutos)', ylabel='Temperatura (°C)',
	title='Temperatura media de cada región vs tiempo')
ax.grid(True)


fig.savefig('TemperaturaMediaCopia.jpg')
